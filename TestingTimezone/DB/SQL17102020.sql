USE [DbTestTime]
GO
/****** Object:  Table [dbo].[tblScheduleTest]    Script Date: 23-10-2020 12:14:11 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblTopic]    Script Date: 23-10-2020 12:14:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[spCreateTest]    Script Date: 23-10-2020 12:14:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Schedule a Test by Teacher
-- Modifications:
-- =============================================
...
BEGIN 
	BEGIN TRY 
		BEGIN TRAN 
		If not exists(select top 1 1 from tblScheduleTest 
		    where TopicId=@TopicId And DATEDIFF(MINUTE,@StartDateTime,StartDateTime) = 0)
		Begin
...
END
GO
/****** Object:  StoredProcedure [dbo].[spGetAllTopics]    Script Date: 23-10-2020 12:14:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spGetUpcomingTest]    Script Date: 23-10-2020 12:14:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN 
	...
	Select T.TopicId, T.Topic, S.StartDateTime, S.Duration,
	DATEADD(mi, Convert(int,LTRIM(DATEDIFF(MINUTE, 0, S.Duration ))),S.StartDateTime) as EndDateTime 
	From tblScheduleTest S inner join tblTopic T on S.TopicId = T.TopicId
	Where DATEDIFF(MINUTE,GETUTCDATE(), DATEADD(mi, Convert(int,LTRIM(DATEDIFF(MINUTE, 0, S.Duration ))),S.StartDateTime)) >= 0 
